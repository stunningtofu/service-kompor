        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 leading-relaxed">
              ...
              Sudah 3+ tahun melayani dengan kualitas terbaik dan harga bersahabat.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li className="flex items-start gap-2">
                <FaMapMarkerAlt className="text-primary text-sm mt-1" aria-hidden="true" />
                <address className="not-italic">
                  Jalan Ronggo Warsito No.65, RT.002/RW.004<br />
                  Dusun Pojok, Desa Sukorejo, Kabupaten Kediri<br />
                  Jawa Timur 64181, Indonesia
                </address>
              </li>
            </ul>
          </div>
